...
print(X_norm)
# graficarLasXs(X_norm[: , 0],Y,'Tamaño en pulgadas (in)','Cantidad Vendida')
# graficarLasXs(X_norm[: , 1],Y,'Peso en Kg','Cantidad Vendida')
# graficarLasXs(X_norm[: , 2],Y,'Temporada meses','Cantidad Vendida')
# graficarLasXs(X_norm[: , 3],Y,'Fabricante','Cantidad Vendida')
# pyplot.show()
...
# 145,22,8,80,187
# 160,22.4,9,100,201
names = ['Tamaño => X1', 'peso => X2', 'meses => X3', 'marca => X4', 'Cantidad vendida => Y']    # Columnas
...
print('Predicinedo la cantidad a vender de televisores: (usando el descenso por el gradiente): Unidades{:.0f}'.format(price))
...
print('Predicinedo la cantidad a vender de televisores: (usando la ecuación de la normal): Unidades{:.0f}'.format(price))
